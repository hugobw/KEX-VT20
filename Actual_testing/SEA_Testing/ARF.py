...
classifiers = [AdaptiveRandomForest(n_estimators = 20, split_confidence = 0.01, grace_period = 50, leaf_prediction = 'nb'),
               AdaptiveRandomForest(n_estimators = 20, split_confidence = 0.01, grace_period = 50, leaf_prediction = 'nb'),
               AdaptiveRandomForest(n_estimators = 20, split_confidence = 0.01, grace_period = 50, leaf_prediction = 'nb'),
               AdaptiveRandomForest(n_estimators = 20, split_confidence = 0.01, grace_period = 50, leaf_prediction = 'nb'),
               AdaptiveRandomForest(n_estimators = 20, split_confidence = 0.01, grace_period = 50, leaf_prediction = 'nb'),
               AdaptiveRandomForest(n_estimators = 20, split_confidence = 0.01, grace_period = 50, leaf_prediction = 'nb'),
...
output_file = open('Results/ARF.csv', mode='w')
